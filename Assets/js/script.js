...
var cityNameEl = document.querySelector("#city-container");
...
var formSubmitHandler = function (event) {
  ...
  var userCity = (recentSearch = cityInputEl.value.trim());

  // recentSearch = cityInputEl.value.trim()
  ...
  fetch(coorApiUrl)
    ...
    .then(function (data) {
      ...
      var userCityName = userCity;
      var userCityLat = data.results[0].geometry.lat;
      var userCityLng = data.results[0].geometry.lng;
      ...
      var weatherApiUrl =
        ...
        "&lon=" +
        userCityLng +
        "&exclude=hourly&appid=f153ce2fe2786b96d0b40ef8d3bdb4a1&units=imperial";
      ...
      fetch(weatherApiUrl)
        ...
        .then(function (data) {
          ...
          // console.log(currentWeatherDescr);

          var futureMaxTemp1 = data.daily[1].temp.max;
          var futureMinTemp1 = data.daily[1].temp.min;
          var futureHumidity1 = data.daily[1].humidity;
          var futureWeatherDescr1 = data.daily[1].weather[0].icon;

          cityNameEl.innerHTML = "";
          var cityEl = document.createElement("h2");
          cityEl.textContent = userCityName + " " + "(" + today + ")";
          ...
          weatherIconImg.src =
            ...
            currentWeatherIcon +
            "@2x.png";
          cityNameEl.appendChild(weatherIconImg);

          tempContainerEl.innerHTML = "";
          var currentTempEl = document.createElement("p");
          currentTempEl.textContent = "Temperature: " + currentTemp + " F";
          tempContainerEl.appendChild(currentTempEl);

          humidityContainerEl.innerHTML = "";
          var currentHumidityEl = document.createElement("p");
          currentHumidityEl.textContent = "Humidity: " + currentHumidity + "%";
          humidityContainerEl.appendChild(currentHumidityEl);

          windSpeedContainerEl.innerHTML = "";
          var currentWindSpeedEl = document.createElement("p");
          currentWindSpeedEl.textContent = "Wind Speed: " + currentWindSpeed;
          windSpeedContainerEl.appendChild(currentWindSpeedEl);

          uvIndexContainerEl.innerHTML = "";
          var currentUVIndexEl = document.createElement("p");
          currentUVIndexEl.textContent = "UV Index: " + currentUVIndex;
          uvIndexContainerEl.appendChild(currentUVIndexEl);

          function uvIndexColor(x) {
            if (x >= 0 && x <= 2) {
              currentUVIndexEl.style.background = "green";
            } else if (x > 2 && x <= 5) {
              ...
              currentUVIndexEl.style.background = "purple";
            }
          }

          uvIndexColor(currentUVIndex);
          ...
          var futureMinTemp1 = data.daily[1].temp.min;
          var futureHumidity1 = data.daily[1].humidity;
          var futureWeatherIcon = data.daily[1].weather[0].icon;


          // Future Temp 1
          var futureTempCont1 = document.querySelector("#future-temp-1");
          var futureTempEl1 = document.createElement("p");

          futureTempCont1.innerHTML = "";
          futureTempEl1.textContent =
            futureMaxTemp1 + "/" + futureMinTemp1 + " F";
          futureTempCont1.appendChild(futureTempEl1);

          //Future Icon 1
          var futureIconCont1 = document.querySelector("#future-icon-1");
          var futureIconEl1 = document.createElement("img");
          futureIconEl1.src =
            "http://openweathermap.org/img/wn/" + futureWeatherIcon + "@2x.png";
          futureTempCont1.appendChild(futureIconEl1);

          //Future Humidity 1
          var futureHumCont1 = document.querySelector("#future-humidity-1");
          var futureHumEl1 = document.createElement("p");
          futureHumEl1.textContent = "Humidity: " + futureHumidity1 + "%";
          futureTempCont1.appendChild(futureHumEl1);

          //Card 2

          //Variables 2
          var futureMaxTemp2 = data.daily[2].temp.max;
          var futureMinTemp2 = data.daily[2].temp.min;
          var futureHumidity2 = data.daily[2].humidity;
          var futureWeatherIcon2 = data.daily[2].weather[0].icon;

          // Future Temp 2
          var futureTempCont2 = document.querySelector("#future-temp-2");
          var futureTempEl2 = document.createElement("p");

          futureTempCont2.innerHTML = "";
          futureTempEl2.textContent =
            futureMaxTemp2 + "/" + futureMinTemp2 + " F";
          futureTempCont2.appendChild(futureTempEl2);

          //Future Icon 2
          var futureIconCont2 = document.querySelector("#future-icon-2");
          var futureIconEl2 = document.createElement("img");
          futureIconEl2.src =
            "http://openweathermap.org/img/wn/" +
            futureWeatherIcon2 +
            "@2x.png";
          futureTempCont2.appendChild(futureIconEl2);

          //Future Humidity 2
          var futureHumCont2 = document.querySelector("#future-humidity-2");
          var futureHumEl2 = document.createElement("p");
          futureHumEl2.textContent = "Humidity: " + futureHumidity2 + "%";
          futureTempCont2.appendChild(futureHumEl2);

          //Card 3

          //Variables 3
          var futureMaxTemp3 = data.daily[3].temp.max;
          var futureMinTemp3 = data.daily[3].temp.min;
          var futureHumidity3 = data.daily[3].humidity;
          var futureWeatherIcon3 = data.daily[3].weather[0].icon;

          // Future Temp 3
          var futureTempCont3 = document.querySelector("#future-temp-3");
          var futureTempEl3 = document.createElement("p");

          futureTempCont3.innerHTML = "";
          futureTempEl3.textContent =
            futureMaxTemp3 + "/" + futureMinTemp3 + " F";
          futureTempCont3.appendChild(futureTempEl3);

          //Future Icon 3
          var futureIconCont3 = document.querySelector("#future-icon-3");
          var futureIconEl3 = document.createElement("img");
          futureIconEl3.src =
            "http://openweathermap.org/img/wn/" +
            futureWeatherIcon3 +
            "@2x.png";
          futureTempCont3.appendChild(futureIconEl3);

          //Future Humidity 3
          var futureHumCont3 = document.querySelector("#future-humidity-3");
          var futureHumEl3 = document.createElement("p");
          futureHumEl3.textContent = "Humidity: " + futureHumidity3 + "%";
          futureTempCont3.appendChild(futureHumEl3);

          //Card 4

          //Variables 4
          var futureMaxTemp4 = data.daily[4].temp.max;
          var futureMinTemp4 = data.daily[4].temp.min;
          var futureHumidity4 = data.daily[4].humidity;
          var futureWeatherIcon4 = data.daily[4].weather[0].icon;

          // Future Temp 4
          var futureTempCont4 = document.querySelector("#future-temp-4");
          var futureTempEl4 = document.createElement("p");

          futureTempCont4.innerHTML = "";
          futureTempEl4.textContent =
            futureMaxTemp4 + "/" + futureMinTemp4 + " F";
          futureTempCont4.appendChild(futureTempEl4);

          //Future Icon 4
          var futureIconCont4 = document.querySelector("#future-icon-4");
          var futureIconEl4 = document.createElement("img");
          futureIconEl4.src =
            "http://openweathermap.org/img/wn/" +
            futureWeatherIcon4 +
            "@2x.png";
          futureTempCont4.appendChild(futureIconEl4);

          //Future Humidity 4
          var futureHumCont4 = document.querySelector("#future-humidity-4");
          var futureHumEl4 = document.createElement("p");
          futureHumEl4.textContent = "Humidity: " + futureHumidity4 + "%";
          futureTempCont4.appendChild(futureHumEl4);

          //Card 5

          //Variables 5
          var futureMaxTemp5 = data.daily[5].temp.max;
          var futureMinTemp5 = data.daily[5].temp.min;
          var futureHumidity5 = data.daily[5].humidity;
          var futureWeatherIcon5 = data.daily[5].weather[0].icon;

          // Future Temp 5
          var futureTempCont5 = document.querySelector("#future-temp-5");
          var futureTempEl5 = document.createElement("p");

          futureTempCont5.innerHTML = "";
          futureTempEl5.textContent =
            futureMaxTemp5 + "/" + futureMinTemp5 + " F";
          futureTempCont5.appendChild(futureTempEl5);

          //Future Icon 5
          var futureIconCont5 = document.querySelector("#future-icon-5");
          var futureIconEl5 = document.createElement("img");
          futureIconEl5.src =
            "http://openweathermap.org/img/wn/" +
            futureWeatherIcon5 +
            "@2x.png";
          futureTempCont5.appendChild(futureIconEl5);

          //Future Humidity 5
          var futureHumCont5 = document.querySelector("#future-humidity-5");
          var futureHumEl5 = document.createElement("p");
          futureHumEl5.textContent = "Humidity: " + futureHumidity5 + "%";
          futureTempCont5.appendChild(futureHumEl5);
          // futureMinTempEl1.textContent = 'Low: ' +
          // futureMinTemp1;
        });
    });
};
...
// citySearchFormEl.addEventListener('submit', getDate);

// console.log(`Original Moment: ${m.toString()}`);
var futureDate1 = m.add(1, "days").format("L");
var futureDate2 = m.add(1, "days").format("L");
var futureDate3 = m.add(1, "days").format("L");
var futureDate4 = m.add(1, "days").format("L");
var futureDate5 = m.add(1, "days").format("L");
...
//Future Date 1
var futureDateCont1 = document.querySelector("#future-date-1");
var futureDateEl1 = document.createElement("h5");
futureDateEl1.textContent = futureDate1;
futureDateCont1.appendChild(futureDateEl1);

//Future Date 2
var futureDateCont2 = document.querySelector("#future-date-2");
var futureDateEl2 = document.createElement("h5");
futureDateEl2.textContent = futureDate2;
futureDateCont2.appendChild(futureDateEl2);

// Future Date 3
var futureDateCont3 = document.querySelector("#future-date-3");
var futureDateEl3 = document.createElement("h5");
futureDateEl3.textContent = futureDate3;
futureDateCont3.appendChild(futureDateEl3);

// Future Date 4
var futureDateCont4 = document.querySelector("#future-date-4");
var futureDateEl4 = document.createElement("h5");
futureDateEl4.textContent = futureDate4;
futureDateCont4.appendChild(futureDateEl4);

// Future Date 5
var futureDateCont5 = document.querySelector("#future-date-5");
var futureDateEl5 = document.createElement("h5");
futureDateEl5.textContent = futureDate5;
futureDateCont5.appendChild(futureDateEl5);
